...
// TCP port to use
const listenPort = "42069";                           // fix it if you like
...
red_app.use('/static', express.static(path.join(__dirname, 'static')))
...
var settings = {
    ...
    functionGlobalContext: { },    // enables global context - add extras here if you need them
...
if (process.platform === 'darwin') {
    ...
    template[0].submenu.unshift({ label: "About "+options.productName||"TripleTriad", selector: "orderFrontStandardAboutPanel:" });
    template[0].submenu.unshift({ type: 'separator' });
    template[0].submenu.unshift({ type: 'separator' });
}
